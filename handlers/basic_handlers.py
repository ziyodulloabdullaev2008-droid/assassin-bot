...
async def cmd_help(message: Message):
    help_text = (
        ...
        "3) <b>Что такое Темп и Лимит</b>\n"
        "• <b>Темп</b> — задержка между чатами во время активной рассылки.\n"
        "• <b>Лимит</b> — сколько сообщений планируется подряд и какой отдых делается после лимита.\n\n"
